...
//  Same as a WeightedQU but as you find the
//  root you make everything point to it
public class PathCompWQU {
    ...
    //make one root connet to the other based on the sizes
    ...
    private int root(int i) {
        while (i != id[i]) {
            //intrestion analisis of change on pg. 44
            id[i] = id[id[i]];
            i = id[i];
        }
        return i;
